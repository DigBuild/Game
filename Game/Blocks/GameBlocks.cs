...
namespace DigBuild.Blocks
{
    public static class GameBlocks
    {
        ...
        {
            Terrain = builder.CreateTmp(new ResourceName(Game.Domain, "terrain"), 0, new VoxelCollider());
            Water = builder.CreateTmp(new ResourceName(Game.Domain, "water"), 1, new VoxelCollider());
